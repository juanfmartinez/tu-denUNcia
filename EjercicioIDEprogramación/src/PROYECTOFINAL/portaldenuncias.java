					...
					if (inicio.equalsIgnoreCase("si")) {
						...
						if (contraadmin.equals(contradmin) && adminentr.equals(admin)) {
							...
							case "Actualizar":
								...
								System.out.println("Ingrese el nuevo status de la denuncia.(Recibida, tramitada, solucionada, NA)");
								pu.setStatus(lector.nextLine());
								
								System.out.println("En caso de que su denuncia ya haya sido enviada se le informa que fue referida hacia la division de ");
