			...
			if (inicio.equals("si".toUpperCase()) || inicio.equals("si")) {
				...
				if (!contraadmin.equals(contradmin) || !adminentr.equals(admin)) {
					...
					case "Ver":
						...
						System.out.println("Las denuncias que se encuentran registradas en el momento son:");

						break;
					case "Ordenar":
						System.out.println(
								"Estimado admin " + admin + "a continuación ordenara todas las denuncias del portal");
						System.out.println("Desea ordenar las denuncias basado en fecha de registro de las mismas?");
						break;
					
					case "borrar":
						System.out
								.println("Estimado admin " + admin + "a continuación borrará las denuncias del portal");
						System.out.println("Indique cual es la denuncia a eliminar");
						break;
				...
				if (respuesta.equalsIgnoreCase("consultar")) {
					...
					System.out.println(
							"Digite su numero de identificación (Cedula de ciudadania, tarjeta de identidad, registro civil, pasaporte, cedula de extranjeria o el que sea pertinente en su caso .)");
					...
					while (true) {
							...
							;
						{
							...
							if ((usuario[persona][0].length() >= 12)) {

								System.out
										.println("La longitud del documento no cumple con los caracteres establecidos");
								break;
							}
							...
							usuario[persona][5] = lector.nextLine(); // Clase date
						}
						...
						System.out.println(
								"Si estos son los datos correctos escriba SI  o NO si hay algun error (tenga en cuenta que si dice \"NO\" debera rellenar el formulario completo nuevamente");
						...
						if (respuesta.equalsIgnoreCase("no")) {
							...
							System.out
									.println("Si ya terminó el registro de su denuncia, por favor, escriba finalizar.");
							String status = lector.nextLine();
							if ((status.equalsIgnoreCase("Finalizar"))) {
								break;
							}
					...
					System.out.println("Pronto tendra respuesta. Gracias por su visita ");
					break;
